...
snapshots its launch environment, a changed effective identity terminates and resumes that ACP
session before the next prompt; unchanged identities keep the existing process.
