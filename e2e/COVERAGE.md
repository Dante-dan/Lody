...
| --------------- | -------- | ----------------- | --------: | ------------------------------------------------------------- | ----------------: | ----------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `LODY-FORK-001` | P1       | session-lifecycle |       4/5 | Fork a completed Session into an independent worktree Session |                 8 | Blocked: Fix the product forkOperation LoroMap update at worktree commit, then rerun the prepared journey through three focused rounds and full regression. | The built desktop reaches asynchronous worktree-fork commit, where replacing the existing forkOperation LoroMap fails with `Map value must be an object` before the target Session is published. |
